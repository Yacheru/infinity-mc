...
export default function Category() {
    ...
    return (
        <div className={'category-box flex w100'}>
            <Link to={'/punishments?category=bans'} className={`category-box-item category-bans ${locate === 'bans' ? 'selected ' : ''}bgc-1 b br20 flex center`}>
            ...
            <Link to={'/punishments?category=mutes'} className={`category-box-item category-mutes ${locate === 'mutes' ? 'selected ' : ''}bgc-1 b br20 flex center`}>
            ...
            <Link to={'/punishments?category=warns'} className={`category-box-item category-warns ${locate === 'warns' ? 'selected ' : ''}bgc-1 b br20 flex center`}>
